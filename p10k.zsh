# Generated by Powerlevel10k configuration wizard on 2022-08-11 at 21:46 PDT.
# Based on romkatv/powerlevel10k/config/p10k-rainbow.zsh, checksum 15312.
# Wizard options: nerdfont-complete + powerline, small icons, rainbow, unicode,
# 12h time, vertical separators, slanted heads, flat tails, 2 lines, disconnected,
...
() {
  ...
  typeset -g POWERLEVEL9K_TIME_FORMAT='%D{%I:%M:%S %p %Z}'
